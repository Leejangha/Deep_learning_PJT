...
if __name__ == '__main__':  # 현재 파일이 메인 프로그램일 경우 작동
    ...
    parser.add_argument('--model_type', type=str, default='Convnext', help='Resnet/Efficientnet/Mobilenet/Vit/Convnext') # 모델 유형 입력(Resnet/Efficientnet)
    parser.add_argument('--model_path', type=str, default='./code_with_dataset/PRPD_Classification/Convnext_Result') # 학습 결과 저장 경로 입력
    parser.add_argument('--load_model_path', type=str, default='./code_with_dataset/PRPD_Classification/Convnext_Result/Convnext_2023_12_18_17_50_28_8.pkl') # 사전학습 가중치 이용 시 모델을 불러오기 위한 경로 입력
