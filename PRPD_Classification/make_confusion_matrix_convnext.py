...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_type', type=str, default='Convnext', help='Resnet/Efficientnet/Mobilenet/Vit/Convnext') # 모델 유형 입력(Resnet/Efficientnet/Mobilenet/Vit/Convnext)
    parser.add_argument('--model_path', type=str, default='./PRPD_Classification/Convnext_Result') # 학습 결과 저장 경로
    parser.add_argument('--load_model_path', type=str, default='./PRPD_Classification/Convnext_Result/Convnext_2025_06_10_17_50_28_8.pkl') # 사전학습 가중치 이용 시 모델을 불러오기 위한 경로 입력
