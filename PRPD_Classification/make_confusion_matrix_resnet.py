...
def main(config): # 모델 학습을 위한 main 함수 선언
...
if __name__ == '__main__':  # 현재 파일이 메인 프로그램일 경우 작동
    ...
    parser.add_argument('--model_type', type=str, default='Resnet', help='Resnet/Efficientnet/Mobilenet/Vit/Convnext') # 모델 유형 입력(Resnet/Efficientnet)
    parser.add_argument('--model_path', type=str, default='./code_with_dataset/PRPD_Classification/Resnet_Result') # 학습 결과 저장 경로 입력
    parser.add_argument('--load_model_path', type=str, default='./code_with_dataset/PRPD_Classification/ResNet_Result/Resnet_2023_11_18_16_09_22_4.pkl') # 사전학습 가중치 이용 시 모델을 불러오기 위한 경로 입력 
