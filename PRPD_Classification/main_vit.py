...
if __name__ == '__main__':  # 현재 파일이 메인 프로그램일 경우 작동
    ...
    parser.add_argument('--patience', type=int, default=3) # ResNet 모델 학습에 사용할 Early Stop Patience 입력 
    parser.add_argument('--model_type', type=str, default='Vit', help='Resnet/Efficientnet') # 모델 유형 입력(Resnet/Efficientnet)
