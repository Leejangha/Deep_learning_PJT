...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_model_path', type=str, default='./PRPD_Classification/Mobilenet_Result/Mobilenet_2025_06_10_17_50_28_8.pkl') # 사전학습 가중치 이용 시 모델을 불러오기 위한 경로 입력
